...
On the Test Packages section we're going to create a new package called _home_ and in that package, we'll create the _HomeController_ Java Class by right clicking the new package and choosing the New Java Class option
