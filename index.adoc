...
Can you try and implement the remove todo feature? You'll have to add a test, the controller implementation and modify the HTML to make it happen. Good luck!
